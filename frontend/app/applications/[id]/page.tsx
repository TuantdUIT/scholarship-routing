...
import { ApplicationReminders } from "@/components/applications/application-reminders"
...
const mockApplicationData = {
  app1: {
    ...
    notes: "Focus on research experience in personal statement. Contact Prof. Smith for reference letter.",
...
export default function ApplicationDetailPage() {
  ...
  const application = mockApplicationData[applicationId as keyof typeof mockApplicationData]
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  <CardTitle className="text-2xl lg:text-3xl">{application.scholarshipTitle}</CardTitle>
                ...
                <div className="flex flex-wrap items-center gap-4 text-muted-foreground mb-4">
                  <span className="font-medium text-foreground">{application.provider}</span>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary">{application.progress}%</div>
                  <div className="text-sm text-muted-foreground">Complete</div>
                  <Progress value={application.progress} className="w-20 h-2 mt-1" />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {application.documents.required.filter((doc) => doc.status === "uploaded").length}/
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {application.reminders.filter((r) => r.isActive).length} pending
                  </div>
                </div>
              </div>
            </div>
