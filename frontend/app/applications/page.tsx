...
const mockApplications = [
  ...
  },
  {
    ...
    documents: {
      ...
      uploaded: [],
      pending: ["CV", "Transcript", "Motivation Letter", "Language Certificate"],
    },
    timeline: [{ date: "2024-01-08", action: "Added to applications", type: "info" }],
    reminders: [{ date: "2024-02-01", message: "Start preparing application documents" }],
  },
  {
    id: "app4",
    scholarshipId: "s4",
    ...
    timeline: [
      ...
      { date: "2024-01-18", action: "Interview invitation received", type: "success" },
    ],
    reminders: [{ date: "2024-01-25", message: "Interview scheduled for January 30th" }],
  },
  {
    id: "app5",
    scholarshipId: "s5",
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-7xl px-4 py-8">
        ...
        {/* Main Content */}
        {viewMode === "kanban" ? (
          <ApplicationKanban applications={sortedApplications} onStatusChange={updateApplicationStatus} />
        ) : (
          <ApplicationTable applications={sortedApplications} onStatusChange={updateApplicationStatus} />
        )}
      </div>
    </div>
  )
