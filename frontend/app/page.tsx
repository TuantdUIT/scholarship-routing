...
import { Search, Target, Calendar, FileText, Users, Globe, TrendingUp, CheckCircle, ArrowRight } from "lucide-react"
  ...
  const features = [
    {
      ...
      description: "AI-powered matching based on your academic profile and preferences",
      color: "text-blue-600",
    },
    {
      icon: Target,
    ...
    },
    {
      ...
      description: "Monitor your application status across multiple scholarships",
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
              Discover graduate study abroad scholarships tailored to your profile with AI-powered matching and
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Our comprehensive platform guides you through every step of your scholarship journey.
            </p>
          </div>
