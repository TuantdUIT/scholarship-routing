...
import { DeadlineStats } from "@/components/calendar/deadline-stats"
...
export default function CalendarPage() {
  ...
  const updateDeadlineStatus = (deadlineId: string, newStatus: string) => {
    setDeadlines((prev) =>
      prev.map((deadline) => (deadline.id === deadlineId ? { ...deadline, status: newStatus } : deadline)),
    )
  }
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-muted-foreground">Stay on top of all your scholarship deadlines and important dates</p>
            </div>
            <Button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {viewMode === "calendar" ? (
              ...
              <DeadlineList deadlines={sortedDeadlines} onStatusChange={updateDeadlineStatus} />
            )}
          </div>
        </div>
      </div>
