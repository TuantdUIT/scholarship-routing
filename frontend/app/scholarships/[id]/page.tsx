...
import { EligibilityPanel } from "@/components/scholarships/eligibility-panel"
import { DocumentsChecklist } from "@/components/scholarships/documents-checklist"
import { ApplicationTimeline } from "@/components/scholarships/application-timeline"
import { RelatedScholarships } from "@/components/scholarships/related-scholarships"
...
const mockScholarshipData = {
  s1: {
    ...
    applicationProcess: [
      {
        ...
        description: "Gather all required documents including transcripts, CV, and references",
        deadline: "2024-02-01",
        status: "pending",
      },
      {
        ...
        description: "Complete the online application form with all supporting documents",
        deadline: "2024-03-01",
        status: "pending",
      },
      {
        ...
        description: "Selected candidates will be invited for virtual or in-person interviews",
        deadline: "2024-04-15",
        status: "pending",
      },
      {
        ...
        description: "Scholarship recipients will be notified of the final decision",
        deadline: "2024-05-01",
        status: "pending",
      },
    ],
    ...
    contactInfo: {
      ...
      website: "https://www.ox.ac.uk/admissions/graduate/fees-and-funding/fees-funding-and-scholarship-search",
    },
    statistics: {
...
export default function ScholarshipDetailPage() {
  ...
  const scholarship = mockScholarshipData[scholarshipId as keyof typeof mockScholarshipData]
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="text-center py-8">
            ...
            <p className="text-muted-foreground mb-4">The scholarship you're looking for doesn't exist.</p>
            <Button asChild>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  <CardTitle className="text-2xl lg:text-3xl">{scholarship.title}</CardTitle>
                  {isUrgent && !isExpired && <Badge variant="destructive">Urgent</Badge>}
                  {isExpired && (
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600">{scholarship.matchScore}%</div>
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" asChild>
                    <a href={scholarship.link} target="_blank" rel="noopener noreferrer" className="flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className={`text-sm ${isUrgent && !isExpired ? "text-orange-600" : "text-muted-foreground"}`}>
                    {new Date(scholarship.deadline).toLocaleDateString()}
                    {!isExpired && <span className="ml-1">({daysLeft} days left)</span>}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {scholarship.statistics.successRate} ({scholarship.statistics.awardsAvailable} awards)
                  </div>
                </div>
              </div>
            </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="whitespace-pre-line text-sm">{scholarship.detailedDescription}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-primary">{scholarship.statistics.totalApplicants}</div>
                    <div className="text-sm text-muted-foreground">Total Applicants</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">{scholarship.statistics.awardsAvailable}</div>
                    <div className="text-sm text-muted-foreground">Awards Available</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-orange-600">{scholarship.statistics.successRate}</div>
                    <div className="text-sm text-muted-foreground">Success Rate</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-600">{scholarship.statistics.averageGpa}</div>
