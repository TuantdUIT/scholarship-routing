...
import { BookmarkCheck, Trash2, ExternalLink, Calendar, MapPin } from "lucide-react"
...
export default function SavedScholarshipsPage() {
  const [savedScholarships, setSavedScholarships] = useState(mockSavedScholarships)
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-4xl px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Scholarships you've bookmarked for future reference and applications</p>
        </div>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {scholarship.status === "applied" && <Badge variant="secondary">Applied</Badge>}
                          {isUrgent && !isExpired && (
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <Button asChild className="flex-1">
                        <a href={`/scholarships/${scholarship.id}`}>View Details</a>
                      </Button>
                      {scholarship.status !== "applied" && <Button variant="outline">Apply Now</Button>}
