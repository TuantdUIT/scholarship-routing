...
import { ScholarshipSort } from "@/components/scholarships/scholarship-sort"
...
const mockScholarships = [
  {
    ...
    requiredDocuments: ["CV", "Transcript", "Personal Statement", "Reference Letters"],
    link: "https://oxford.edu/scholarships",
    matchScore: 85,
    hardConditionsPassed: true,
    failedConditions: [],
    description: "Prestigious scholarship for outstanding graduate students in STEM fields.",
  ...
  },
  {
    ...
    requiredDocuments: ["CV", "Transcript", "Research Proposal", "Reference Letters"],
    link: "https://mit.edu/fellowships",
    matchScore: 72,
    hardConditionsPassed: false,
    failedConditions: ["GPA 3.4 < min 3.7"],
    description: "Elite fellowship for PhD students in cutting-edge technology research.",
  ...
  },
  {
    ...
    requiredDocuments: ["CV", "Transcript", "Motivation Letter", "Language Certificate"],
...
export default function ScholarshipsPage() {
  ...
  const filteredScholarships = scholarships.filter((scholarship) => {
    ...
    if (filters.degreeLevel && scholarship.degreeLevel !== filters.degreeLevel) return false
    if (filters.countries.length > 0 && !filters.countries.includes(scholarship.country)) return false
  ...
  const passedCount = filteredScholarships.filter((s) => s.hardConditionsPassed).length
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-7xl px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Scholarship Discovery</h1>
          <p className="text-muted-foreground text-sm md:text-base">
            Find scholarships that match your profile with AI-powered recommendations
          </p>
        </div>
                ...
                <div className="block lg:hidden">
                  <Sheet>
                    ...
                    <SheetContent side="left" className="w-full sm:w-80">
                      ...
                      <div className="mt-6">
                        <ScholarshipFilters filters={filters} onFiltersChange={setFilters} />
                      </div>
                    </SheetContent>
                  </Sheet>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-sm text-muted-foreground">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                    ...
                    <span className="text-green-600">{passedCount} match your profile</span>
                    <Separator orientation="vertical" className="h-4 hidden sm:block" />
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Progress value={(passedCount / totalCount) * 100} className="flex-1 sm:w-20 h-2" />
                  <span className="text-sm font-medium">{Math.round((passedCount / totalCount) * 100)}%</span>
                </div>
              </div>
            </div>
          </CardContent>
