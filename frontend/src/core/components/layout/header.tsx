...
export function Header() {
	...
	const isRoutePublic = (href: string) =>
		href.startsWith("/scholarships") || href === "/";
	...
	const getNavigationHref = (href: string) => {
		...
		return isAuthenticated
			? href
			: `/onboarding?redirect=${encodeURIComponent(href)}`;
	};
