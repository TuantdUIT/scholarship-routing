...
const degreeTypes = ["Master's Degree", "PhD", "Professional Degree", "Research Fellowship"]

const scholarshipAmounts = ["Partial Tuition", "Full Tuition", "Full Tuition + Living Expenses", "Any Amount"]
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Select countries where you'd like to study (select multiple)</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Select value={data.desiredDegree} onValueChange={(value) => updateData({ desiredDegree: value })}>
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select value={data.scholarshipAmount} onValueChange={(value) => updateData({ scholarshipAmount: value })}>
            <SelectTrigger>
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <p className="text-sm text-green-800">
          <strong>Smart Matching:</strong> We'll use these preferences to prioritize scholarships that best match your
          goals, but you'll still see all relevant opportunities.
        </p>
      </div>
    </div>
  )
