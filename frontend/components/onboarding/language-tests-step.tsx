...
export function LanguageTestsStep({ data, updateData }: LanguageTestsStepProps) {
  return (
    <div className="space-y-6">
      <div className="text-sm text-muted-foreground mb-4">
        Please provide scores for at least one English proficiency test. Standardized tests are optional.
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Required for most international scholarships</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Optional - Required for some programs</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          <strong>Tip:</strong> If you haven't taken these tests yet, you can update your scores later. We'll help you
          find scholarships that match your current qualifications.
        </p>
      </div>
    </div>
  )
