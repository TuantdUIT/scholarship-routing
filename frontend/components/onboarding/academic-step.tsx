    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Select value={data.gpaScale} onValueChange={(value) => updateData({ gpaScale: value })}>
            <SelectTrigger>
      ...
      <div className="space-y-4">
        ...
        <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6">
          <div className="text-center">
            ...
            {data.transcriptFile && (
              <p className="mt-2 text-sm text-green-600">✓ {data.transcriptFile.name} uploaded</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="text-sm text-muted-foreground">
        Your GPA will be used to filter scholarships with minimum GPA requirements.
      </div>
    </div>
  )
}
