...
interface Document {
  id: string
  name: string
  type: "cv" | "transcript" | "sop" | "recommendation" | "certificate" | "portfolio" | "other"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Manage your application documents and certificates</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Required documents for scholarship applications</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              {requiredDocs.map((docType) => {
                const isUploaded = documents.some((doc) => doc.type === docType.value && doc.status === "verified")
                return (
          ...
          <CardContent>
            <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-8">
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">PDF, DOC, DOCX files up to 10MB each</p>
        ...
        <Card className="text-center py-8">
          <CardContent>
            ...
            <p className="text-muted-foreground mb-4">
              Upload your documents to complete your scholarship application profile
            </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-blue-800">
              ...
              <ul className="space-y-1 text-xs">
                <li>• CV/Resume should be up-to-date and professionally formatted</li>
                <li>• Transcripts must be official and include GPA information</li>
                <li>• All documents should be in English or include certified translations</li>
