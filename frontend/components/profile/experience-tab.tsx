    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Your professional and research experience</p>
        </div>
        {isEditMode && (
            ...
            <CardHeader className="pb-3">
              <div className="flex justify-between items-start">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <CardTitle className="text-base">{experience.role || "New Position"}</CardTitle>
                    <p className="text-sm text-muted-foreground">{experience.company}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  <Badge variant={getTypeColor(experience.type)}>{experience.type.replace("-", " ")}</Badge>
                  {isEditMode && (
                    <Button
                      variant="ghost"
                      size="sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    ...
                    <div className="p-2 text-sm capitalize">{experience.type.replace("-", " ")}</div>
                  )}
                </div>
