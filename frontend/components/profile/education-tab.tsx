...
const degreeTypes = ["Bachelor's", "Master's", "PhD", "Professional", "Diploma", "Certificate"]
            ...
            <CardHeader className="pb-3">
              <div className="flex justify-between items-start">
                <div className="flex items-center space-x-2">
                  <CardTitle className="text-base">{education.institution || "New Institution"}</CardTitle>
                  <Badge variant={getStatusColor(education.status)}>{education.status.replace("-", " ")}</Badge>
                </div>
                {isEditMode && (
                  <Button
                    variant="ghost"
                ...
                <div className="space-y-2">
                  ...
                  {isEditMode ? (
                    <Select
                      ...
                      onValueChange={(value) => updateEducation(education.id, "status", value as Education["status"])}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                    ...
                    <div className="p-2 text-sm capitalize">{education.status.replace("-", " ")}</div>
                  )}
                </div>
                  ...
                  {isEditMode ? (
                    <div className="flex space-x-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => updateEducation(education.id, "gpaScale", value)}
                      >
