...
export function CVUploadModal({ open, onOpenChange }: CVUploadModalProps) {
  ...
  const mockParsedFields: ParsedField[] = [
    ...
    { field: "Education", value: "Master's in Computer Science", confidence: 92 },
    { field: "Experience", value: "3 years software development", confidence: 88 },
    { field: "Skills", value: "Python, JavaScript, Machine Learning", confidence: 85 },
  ]
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload your CV and we'll automatically extract information to update your profile
          </DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="p-6">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Extracting information from your CV using AI</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          {uploadStatus === "complete" && (
            <div className="space-y-4">
                    ...
                    {parsedFields.map((field, index) => (
                      <div key={index} className="flex justify-between items-center p-2 bg-muted/50 rounded">
                        ...
                        <div className="flex items-center space-x-2">
                          <span className={`text-xs ${getConfidenceColor(field.confidence)}`}>{field.confidence}%</span>
                          {field.confidence >= 90 ? (
              ...
              <div className="flex justify-end space-x-2">
                ...
                <Button onClick={handleAcceptFields}>Update Profile with Extracted Data</Button>
              </div>
            </div>
          )}
