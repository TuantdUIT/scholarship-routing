    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Key milestones and deadlines for this scholarship application</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            {scholarship.applicationProcess.map((step: any, index: number) => {
              ...
              const daysLeft = Math.ceil(
                (new Date(step.deadline).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24),
              )
                  ...
                  <div className="flex-1 pb-8">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {step.status === "completed" && <Badge variant="default">Completed</Badge>}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className={`${stepStatus === "urgent" ? "text-red-600" : "text-muted-foreground"}`}>
                      ...
                      {step.status !== "completed" && stepStatus !== "overdue" && (
                        <Button variant="outline" size="sm">
                          {stepStatus === "urgent" ? "Complete Now" : "Prepare"}
                        </Button>
                      )}
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 border rounded-lg">
              ...
              <div>
                ...
                <div className="text-sm text-red-600">{new Date(scholarship.deadline).toLocaleDateString()}</div>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Contact the scholarship provider for questions</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-muted-foreground">{scholarship.contactInfo.phone}</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
