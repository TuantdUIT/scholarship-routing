...
export function ScholarshipFilters({ filters, onFiltersChange }: ScholarshipFiltersProps) {
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>Filter by minimum eligibility criteria</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>Adjust how we calculate your match score</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div className="space-y-2">
          ...
          <div className="text-xs text-muted-foreground">
            Adjust these weights to prioritize what matters most for your scholarship matching.
          </div>
        </CardContent>
      </Card>
    </div>
