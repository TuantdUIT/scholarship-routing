...
export function EligibilityPanel({ scholarship }: EligibilityPanelProps) {
  const checkEligibility = () => {
    ...
    const nationalityCheck = {
      ...
      passed: scholarship.hardConditions.allowedNationalities.includes(mockUserProfile.nationality),
      type: "hard",
    }
    ...
    const fieldCheck = {
      ...
      passed: scholarship.hardConditions.requiredField.includes(mockUserProfile.field),
      type: "hard",
    }
  ...
  const hardRequirementsPassed = eligibilityResults.filter((r) => r.type === "hard").every((r) => r.passed)
  ...
  const getSoftScoreBreakdown = () => {
    ...
    return {
      ...
      totalScore,
      breakdown: [
        { name: "GPA", score: scores.gpa, weight: weights.gpa, weighted: weightedScores.gpa },
        {
          name: "Publications",
    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Mandatory criteria that must be met to be eligible</CardDescription>
            </div>
            ...
            {eligibilityResults.map((result, index) => (
              <div key={index} className="flex items-center justify-between p-3 rounded-lg border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-sm">{result.requirement}</div>
          ...
          {scholarship.hardConditions.additionalRequirements && (
            <div className="mt-4">
              ...
              <ul className="space-y-1">
                {scholarship.hardConditions.additionalRequirements.map((req: string, index: number) => (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>How your profile compares for this scholarship's soft criteria</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-primary mb-2">{Math.round(softScoreData.totalScore)}%</div>
            <div className="text-sm text-muted-foreground">Overall Competitive Score</div>
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-64" align="end">
                        <div className="space-y-2 text-sm">
                          ...
                          <div>Weighted Score: {Math.round(item.weighted)}%</div>
                        </div>
                      </PopoverContent>
                    </Popover>
                  </div>
              ...
              <div className="text-sm text-blue-800">
                ...
                <ul className="space-y-1 text-xs">
                  {softScoreData.breakdown
                    ...
                    .map((item, index) => (
                      <li key={index}>
                        • Strengthen your {item.name.toLowerCase()} to boost your competitive advantage
                      </li>
                    ))}
                </ul>
              </div>
          ...
          {hardRequirementsPassed ? (
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-green-600">
                ...
                <span className="font-medium">You meet all hard requirements!</span>
              </div>
              <p className="text-sm text-muted-foreground">
                Focus on strengthening your soft criteria to improve your competitive position. Consider highlighting
                your unique experiences and achievements in your application.
              </p>
            </div>
          ) : (
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-red-600">
                ...
                <span className="font-medium">You don't meet all hard requirements</span>
              </div>
              <p className="text-sm text-muted-foreground">
                Work on meeting the failed requirements before applying. Consider retaking tests or gaining additional
