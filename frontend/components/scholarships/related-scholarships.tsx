...
export function RelatedScholarships({ currentScholarshipId }: RelatedScholarshipsProps) {
  const relatedScholarships = mockRelatedScholarships.filter((s) => s.id !== currentScholarshipId)
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Other scholarships that might match your profile and interests</CardDescription>
        </CardHeader>
      </Card>
              ...
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-center">
                    <div className="text-xl font-bold text-green-600">{scholarship.matchScore}%</div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-3 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`${isUrgent && !isExpired ? "text-orange-600" : "text-muted-foreground"}`}>
      ...
      <Card className="text-center py-8">
        <CardContent>
          <h3 className="text-lg font-semibold mb-2">Looking for More Options?</h3>
          <p className="text-muted-foreground mb-4">
            Explore our full database of scholarships to find more opportunities that match your profile.
          </p>
          <Button asChild>
